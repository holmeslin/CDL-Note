...
### 5.1.1 Key security terms and concepts 關鍵安全術語和概念
...
然而，特權訪問的濫用可能會帶來風險，因此，小心管理和監控這種訪問是至關重要的。
...
### 5.1.2 Cloud security components 雲安全組件
...
透過實施這些措施，組織可以確保其雲端中的系統和應用程式在任何需要的時候都能保持可訪問，促進業務持續性，即使面對潛在的干擾也能如此。
...
他們完全掌控自己的硬體、軟體和網絡組件，這增強了對其內部環境的信任感。
...
這些網路犯罪分子採用「釣魚攻擊」，收集有關您、您的員工或學生的個人詳細信息。
...
第三個 A，審計（有時稱為會計），在監控和追蹤系統內部的用戶活動中扮演著關鍵角色。
